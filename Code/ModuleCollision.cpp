...
ModuleCollision::ModuleCollision()
{
	...
	matrix[COLLIDER_PLAYER_SHOT_2][COLLIDER_PLAYER_2] = true;
	...
	matrix[COLLIDER_PLAYER_SHOT_2][COLLIDER_SHIELD_1] = false;
	matrix[COLLIDER_PLAYER_SHOT_2][COLLIDER_SHIELD_2] = false;
	matrix[COLLIDER_PLAYER_SHOT_2][COLLIDER_NONE] = false;
	matrix[COLLIDER_PLAYER_SHOT_2][COLLIDER_NONE_PLAYER_2] = false;
	...
	matrix[COLLIDER_SHIELD_1][COLLIDER_ENEMY_SHOT] = false;
	...
	matrix[COLLIDER_SHIELD_2][COLLIDER_ENEMY_SHOT] = false;
